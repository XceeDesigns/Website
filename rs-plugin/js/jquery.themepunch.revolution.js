	...
	jQuery.fn.extend({
		...
		revolution: function(options) {
				...
				var defaults = {
					...
					return this.each(function() {
						...
						// CHECK IF Tweenlight IS LOADED AT ALL
						if (punchgs.Tweenlight==undefined) {
						   if (window.tplogs==true)
						...
						if (window.tplogs==true)
							try{ console.info("GreenSock Engine Version in Slider Revolution:"+punchgs.Tweenlight.version);
							} catch(e) {
						...
						if (options.simplifyAll=="on") {
							...
							punchgs.Tweenlight.lagSmoothing(1000,16);
							punchgs.force3D = "true";
						}
		...
		revkill: function(oy) {
						...
						if (container!=undefined && container.length>0 && jQuery('body').find('#'+container.attr('id')).length>0) {
							...
							punchgs.Tweenlight.killTweensOf(container.find('*'),false);
							punchgs.Tweenlight.killTweensOf(container,false);
...
********************************/
		...
		var containerResized = function (container,opt) {
			...
			punchgs.Tweenlight.set(nextsh.find('.defaultimg'),{opacity:0});
		...
		var handleSpecialPreviews = function(opt) {
			...
			if (arr.hasClass("preview2") && !arr.hasClass("hashoveralready")) {
				...
				if (!is_mobile())
					...
					punchgs.Tweenlight.set(th,{autoAlpha:0});
				}
			...
			if (!arr.hasClass("preview4")) {
				...
				punchgs.Tweenlight.to(raimg,0.5,{autoAlpha:0,onComplete:function() {
					raimg.css({'backgroundImage':'url('+nextimgsrc+')'});
					laimg.css({'backgroundImage':'url('+previmgsrc+')'});
				}});
				punchgs.Tweenlight.to(laimg,0.5,{autoAlpha:0,onComplete:function() {
					punchgs.Tweenlight.to(raimg,0.5,{autoAlpha:1,delay:0.2});
					punchgs.Tweenlight.to(laimg,0.5,{autoAlpha:1,delay:0.2});
				}});
			} else {
				...
				punchgs.Tweenlight.fromTo(raimg_b,0.8,{force3D:punchgs.force3d,x:0},{x:-raimg.width(),ease:punchgs.Power3.easeOut,delay:1,onComplete:function() {
					raimg.css({'backgroundImage':'url('+nextimgsrc+')'});
					punchgs.Tweenlight.set(raimg_b,{x:0});
				}});
				punchgs.Tweenlight.fromTo(laimg_b,0.8,{force3D:punchgs.force3d,x:0},{x:raimg.width(),ease:punchgs.Power3.easeOut,delay:1,onComplete:function() {
					laimg.css({'backgroundImage':'url('+previmgsrc+')'});
					punchgs.Tweenlight.set(laimg_b,{x:0});
				}});



				punchgs.Tweenlight.fromTo(raimg,0.8,{x:0},{force3D:punchgs.force3d,x:-raimg.width(),ease:punchgs.Power3.easeOut,delay:1,onComplete:function() {
					punchgs.Tweenlight.set(raimg,{x:0});
				}});
				punchgs.Tweenlight.fromTo(laimg,0.8,{x:0},{force3D:punchgs.force3d,x:raimg.width(),ease:punchgs.Power3.easeOut,delay:1,onComplete:function() {
					punchgs.Tweenlight.set(laimg,{x:0});
				}});
			}
			...
			if (rar.hasClass("preview4") && !rar.hasClass("hashoveralready")) {
				...
				rar.hover(function() {
					...
					punchgs.Tweenlight.fromTo(iw,0.4,{x:iw.width()},{x:0,delay:0.3,ease:punchgs.Power3.easeOut,overwrite:"all"});
					punchgs.Tweenlight.to(all,0.2,{autoAlpha:1,overwrite:"all"});

				},function() {
					var iw = jQuery(this).find('.tp-arr-iwrapper');
					var all = jQuery(this).find('.tp-arr-allwrapper');
					punchgs.Tweenlight.to(iw,0.4,{x:iw.width(),ease:punchgs.Power3.easeOut,delay:0.2,overwrite:"all"});
					punchgs.Tweenlight.to(all,0.2,{delay:0.6,autoAlpha:0,overwrite:"all"});
				});
				...
				lar.hover(function() {
					var iw = jQuery(this).find('.tp-arr-iwrapper');
					var all = jQuery(this).find('.tp-arr-allwrapper');
					punchgs.Tweenlight.fromTo(iw,0.4,{x:(0-iw.width())},{x:0,delay:0.3,ease:punchgs.Power3.easeOut,overwrite:"all"});
					punchgs.Tweenlight.to(all,0.2,{autoAlpha:1,overwrite:"all"});

				},function() {
					var iw = jQuery(this).find('.tp-arr-iwrapper');
					var all = jQuery(this).find('.tp-arr-allwrapper');
					punchgs.Tweenlight.to(iw,0.4,{x:(0-iw.width()),ease:punchgs.Power3.easeOut,delay:0.2,overwrite:"all"});
					punchgs.Tweenlight.to(all,0.2,{delay:0.6,autoAlpha:0,overwrite:"all"});
				});
						...
						for (var j=0;j<opt.slots;j++) {
							...
							for (var i=0;i<opt.slots;i++) 	{
								...
								if (scalestart!=undefined && rotatestart!=undefined)
										punchgs.Tweenlight.set(sh.find('.slot').last(),{rotationZ:rotatestart});
							}
							x=x+basicsize;
						}
					break;
		...
		********************************/
		...
		var swapSlideProgress = function(container,opt) {
			...
			if (opt.firststart==1)
				punchgs.Tweenlight.set(actli,{autoAlpha:0});

			punchgs.Tweenlight.set(actli,{zIndex:18});
			punchgs.Tweenlight.set(nextli,{autoAlpha:0,zIndex:20});
		...
		*******************************************/
		...
		/*	if (opt.ffnn == undefined) opt.ffnn=0;
			...
			*/
			...
			var mtl = new punchgs.Timelinelight({onComplete:function() {
							letItFree(container,opt,nextsh,actsh,nextli,actli,mtl);
						}});
			//SET DEFAULT IMG UNVISIBLE AT START
			mtl.add(punchgs.Tweenlight.set(nextsh.find('.defaultimg'),{opacity:0}));
			mtl.pause();
			...
			if (nexttrans==0) {								// BOXSLIDE
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							mtl.add(punchgs.Tweenlight.from(ss,(masterspeed)/600,
			...
			if (nexttrans==1) {
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							mtl.add(punchgs.Tweenlight.from(ss,rand/1000,
			...
			if (nexttrans==2) {
						...
						var subtl = new punchgs.Timelinelight();
						// ALL OLD SLOTS SHOULD BE SLIDED TO THE RIGHT
						actsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
							subtl.add(punchgs.Tweenlight.to(ss,masterspeed/1000,{left:opt.slotw, force3D:"auto",rotation:(0-opt.rotate)}),0);
							mtl.add(subtl,0);
						});
						...
						nextsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
							subtl.add(punchgs.Tweenlight.from(ss,masterspeed/1000,{left:0-opt.slotw, force3D:"auto",rotation:opt.rotate}),0);
							mtl.add(subtl,0);
						});
			}
			...
			if (nexttrans==3) {
						...
						actsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
							subtl.add(punchgs.Tweenlight.to(ss,masterspeed/1000,{top:opt.sloth,rotation:opt.rotate,force3D:"auto",transformPerspective:600}),0);
							mtl.add(subtl,0);
						...
						nextsh.find('.slotslide').each(function() {
							var ss=jQuery(this);
							subtl.add(punchgs.Tweenlight.from(ss,masterspeed/1000,{top:0-opt.sloth,rotation:opt.rotate,ease:punchgs.Power2.easeOut,force3D:"auto",transformPerspective:600}),0);
							mtl.add(subtl,0);
						});
			}
			...
			if (nexttrans==4 || nexttrans==5) {
						...
						var cspeed = (masterspeed)/1000,
							ticker = cspeed,
							subtl = new punchgs.Timelinelight();

						actsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
							var del = (i*cspeed)/opt.slots;
							if (nexttrans==5) del = ((opt.slots-i-1)*cspeed)/(opt.slots)/1.5;
							subtl.add(punchgs.Tweenlight.to(ss,cspeed*3,{transformPerspective:600,force3D:"auto",top:0+opt.height,opacity:0.5,rotation:opt.rotate,ease:punchgs.Power2.easeInOut,delay:del}),0);
							mtl.add(subtl,0);
						});
						...
						nextsh.find('.slotslide').each(function(i) {
							...
							var del = (i*cspeed)/opt.slots;
							if (nexttrans==5) del = ((opt.slots-i-1)*cspeed)/(opt.slots)/1.5;
							subtl.add(punchgs.Tweenlight.from(ss,cspeed*3,
			...
			if (nexttrans==6) {
						...
						actsh.find('.slotslide').each(function(i) {
							...
							subtl.add(punchgs.Tweenlight.to(ss,(masterspeed+tempo)/1000,{top:0+opt.height,opacity:1,force3D:"auto",rotation:opt.rotate,ease:punchgs.Power2.easeInOut}),0);
							mtl.add(subtl,0);
						});
						...
						nextsh.find('.slotslide').each(function(i) {
							...
							subtl.add(punchgs.Tweenlight.from(ss,(masterspeed+tempo)/1000,
			...
			if (nexttrans==7) {
						...
						actsh.find('.slotslide').each(function() {
							...
							subtl.add(punchgs.Tweenlight.to(ss,masterspeed/1000,{
						...
						nextsh.find('.slotslide').each(function(i) {
							...
							subtl.add(punchgs.Tweenlight.fromTo(ss,masterspeed/1000,
			...
			if (nexttrans==9 || nexttrans==10) {
						...
						nextsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
							ssamount++;
							mtl.add(punchgs.Tweenlight.fromTo(ss,masterspeed/1000,{autoAlpha:0,force3D:"auto",transformPerspective:600},
			...
			if (nexttrans==11 || nexttrans==26) {
						...
						nextsh.find('.slotslide').each(function(i) {
							var ss=jQuery(this);
							mtl.add(punchgs.Tweenlight.from(ss,masterspeed/1000,{autoAlpha:0,force3D:"auto",ease:punchgs.Power2.easeInOut}),0);
						});
			}
			...
			if (nexttrans==12 || nexttrans==13 || nexttrans==14 || nexttrans==15) {
						...
						setTimeout(function() {
							punchgs.Tweenlight.set(actsh.find('.defaultimg'),{autoAlpha:0});
						...
						mtl.add(punchgs.Tweenlight.from(ssn,speedy,
						...
						if (specials!=1)
							switch (nexttrans) {
								case 12:
									mtl.add(punchgs.Tweenlight.to(ssa,speedy2,{'left':(0-oow)+'px',force3D:"auto",scale:scal,opacity:op,rotation:opt.rotate,ease:easeitout}),0);
								break;
								case 15:
									mtl.add(punchgs.Tweenlight.to(ssa,speedy2,{'left':(oow)+'px',force3D:"auto",scale:scal,opacity:op,rotation:opt.rotate,ease:easeitout}),0);
								break;
								case 13:
									mtl.add(punchgs.Tweenlight.to(ssa,speedy2,{'top':(0-ooh)+'px',force3D:"auto",scale:scal,opacity:op,rotation:opt.rotate,ease:easeitout}),0);
								break;
								case 14:
									mtl.add(punchgs.Tweenlight.to(ssa,speedy2,{'top':(ooh)+'px',force3D:"auto",scale:scal,opacity:op,rotation:opt.rotate,ease:easeitout}),0);
								break;
							}
			...
			if (nexttrans==16) {						// PAPERCUT
					...
					var subtl = new punchgs.Timelinelight();
					mtl.add(punchgs.Tweenlight.set(actli,{'position':'absolute','z-index':20}),0);
					mtl.add(punchgs.Tweenlight.set(nextli,{'position':'absolute','z-index':15}),0);
					...
					mtl.add(punchgs.Tweenlight.set(actli.find('.tp-half-two'),
					                 {width:oow,height:ooh,overflow:'hidden',zIndex:15,position:'absolute',top:ooh/2,left:'0px',transformPerspective:600,transformOrigin:"center bottom"}),0);

					mtl.add(punchgs.Tweenlight.set(actli.find('.tp-half-one'),
					...
					mtl.add(punchgs.Tweenlight.set(actli.find('.tp-half-one'),{overflow:'hidden'}),0);
					mtl.add(punchgs.Tweenlight.fromTo(actli.find('.tp-half-one'),masterspeed/800,
					                 {width:oow,height:ooh/2,position:'absolute',top:'0px',left:'0px',force3D:"auto",transformOrigin:"center top"},
					                 {scale:sc1,rotation:ro1,y:(0-ooh-ooh/4),autoAlpha:0,ease:punchgs.Power2.easeInOut}),0);
					mtl.add(punchgs.Tweenlight.fromTo(actli.find('.tp-half-two'),masterspeed/800,
					                 {width:oow,height:ooh,overflow:'hidden',position:'absolute',top:ooh/2,left:'0px',force3D:"auto",transformOrigin:"center bottom"},
					                 {scale:sc2,rotation:ro2,y:ooh+ooh/4,ease:punchgs.Power2.easeInOut,autoAlpha:0,onComplete:function() {
						                // CLEAN UP
										punchgs.Tweenlight.set(actli,{'position':'absolute','z-index':15});
										punchgs.Tweenlight.set(nextli,{'position':'absolute','z-index':20});
					...
					subtl.add(punchgs.Tweenlight.set(nextsh.find('.defaultimg'),{autoAlpha:1}),0);

					if (actli.html()!=null)
						mtl.add(punchgs.Tweenlight.fromTo(nextli,(masterspeed-200)/1000,
			...
			if (nexttrans==17) {								// 3D CURTAIN HORIZONTAL
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							mtl.add(punchgs.Tweenlight.fromTo(ss,(masterspeed)/800,
			...
			if (nexttrans==18) {								// 3D CURTAIN VERTICAL
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							mtl.add(punchgs.Tweenlight.fromTo(ss,(masterspeed)/500,
			...
			if (nexttrans==19 || nexttrans==22) {								// IN CUBE
						...
						mtl.add(punchgs.Tweenlight.set(actli,{zIndex:20}),0);
						mtl.add(punchgs.Tweenlight.set(nextli,{zIndex:20}),0);
						setTimeout(function() {
							actsh.find('.defaultimg').css({opacity:0});
						},100);
						...
						// ALL NEW SLOTS SHOULD BE SLIDED FROM THE LEFT TO THE RIGHT
						punchgs.Tweenlight.set(container,{transformStyle:"flat",backfaceVisibility:"hidden",transformPerspective:600});
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							subtl.add(punchgs.Tweenlight.to(ss,0.1,{autoAlpha:1,delay:(j*50)/1000}),0);
							mtl.add(subtl);
						});
			...
			if (nexttrans==20 ) {								// FLYIN
						...
						nextsh.find('.slotslide').each(function(j) {
							...
							mtl.add(punchgs.Tweenlight.fromTo(ss,masterspeed/1500,
							...
							mtl.add(punchgs.Tweenlight.fromTo(ss,masterspeed/1000,
							...
							mtl.add(punchgs.Tweenlight.to(ss,0.1,{opacity:1,force3D:"auto",delay:(j*50)/1000+masterspeed/2000}),0);
						...
						actsh.find('.slotslide').each(function(j) {
							...
							mtl.add(punchgs.Tweenlight.to(ss,0.1,{force3D:"auto",opacity:0,delay:(j*50)/1000+(masterspeed/1000 - (masterspeed/10000))}),0);
						});
			}
			...
			if (nexttrans==23 || nexttrans == 24) {								// cube-horizontal - inboxhorizontal
						...
						punchgs.Tweenlight.set(container,{transformStyle:"preserve-3d",backfaceVisibility:"hidden",perspective:2500});
										nextsh.find('.slotslide').each(function(j) {
							var ss=jQuery(this);
							mtl.add(punchgs.Tweenlight.fromTo(ss,masterspeed/1000,
			...
			punchgs.Tweenlight.to(nextli,0.001,{autoAlpha:1});
		...
		**************************************/
		var letItFree = function(container,opt,nextsh,actsh,nextli,actli,mtl) {
					punchgs.Tweenlight.to(nextsh.find('.defaultimg'),0.001,{autoAlpha:1,onComplete:function() {
						removeSlots(container,opt,nextli);
					}});
					if (nextli.index()!=actli.index()) {
						punchgs.Tweenlight.to(actli,0.2,{autoAlpha:0,onComplete:function() {
		...
		var vimeoready_auto = function(player_id,autoplay) {
				...
				froogaloop.addEvent('ready', function(data) {
						...
						// PLAY VIDEO IF THUMBNAIL HAS BEEN CLICKED
						 nextcaption.find('.tp-thumb-image').click(function() {
							 punchgs.Tweenlight.to(jQuery(this),0.3,{autoAlpha:0,force3D:"auto",ease:punchgs.Power3.easeInOut})
							 froogaloop.api("play");
						 })
					});
				},150);
			...
			var updateHTML5Size = function(pc,container) {
					...
					if (windowAspect < mediaAspect) {
						// taller
						punchgs.Tweenlight.to(pc,0.0001,{width:windowH*mediaAspect,force3D:"auto",top:0,
												left:0-(windowH*mediaAspect-windowW)/2,
												height:windowH});

					} else {
						// wider
						punchgs.Tweenlight.to(pc,0.0001,{width:windowW,force3D:"auto",top:0-(windowW/mediaAspect-windowH)/2,
												left:0,
				...
				var animateTheCaptions = function(nextli, opt,recalled,mtl) {
						...
						if (nextli.data('ctl')==undefined) {
							nextli.data('ctl',new punchgs.Timelinelight());
						}
						...
						allcaptions.each(function(i) {
								...
								if (handlecaption==0) {
									...
									if (nextcaption.hasClass("tp-videolayer") || nextcaption.find('iframe').length>0 || nextcaption.find('video').length>0 ) {
										...
										nextcaption.find('iframe').each(function() {
												...
												punchgs.Tweenlight.to(ifr,0.1,{autoAlpha:1, zIndex:0, transformStyle:"preserve-3d",z:0,rotationX:0,force3D:"auto"});
												if (is_mobile()) {
												...
												if (nextcaption.data('videoposter')!=undefined && nextcaption.data('videoposter').length>2 && nextcaption.data('autoplay')!=true && !internrecalled) {
													if (nextcaption.find('.tp-thumb-image').length==0)
													  ...
													  punchgs.Tweenlight.set(nextcaption.find('.tp-thumb-image'),{autoAlpha:1});
												}
							...
							punchgs.Tweenlight.set(nextcaption,{top:calcy,left:calcx,overwrite:"auto"});
							...
							if (!internrecalled) {
									...
									var tl = new punchgs.Timelinelight({smoothChildTiming:true,onStart:tlstart});
									tl.pause();
									...
									var newtl = new punchgs.Timelinelight();


									if (staticdirection != 2) {

										// CHANGE to punchgs.Tweenlight.  if Yoyo and Repeat is used. Dont forget to laod the Right Tools for it !!
										if (ncc.match("customin")) {
											  if (animobject != nextcaption)
												  tl.add(punchgs.Tweenlight.set(nextcaption, { force3D:"auto",opacity:1,scaleX:1,scaleY:1,rotationX:0,rotationY:0,rotationZ:0,skewX:0,skewY:0,z:0,x:0,y:0,visibility:'visible',delay:0,overwrite:"all"}));
											  ...
											  tl.add(newtl.staggerFromTo(animobject,mspeed,frm,endfrm,elemdelay),"frame0");
												...
												if (ncc.match("randomrotate") && animobject != nextcaption) {
													...
													for (var i=0;i<animobject.length;i++) {
														...
														tl.append(punchgs.Tweenlight.fromTo(animobject[i],mspeed,obj,endobj),"frame0");
													}
												...
												tl.add(newtl.staggerFromTo(animobject,mspeed,frm,endfrm,elemdelay),"frame0");
												//tl.add(punchgs.Tweenlight.fromTo(nextcaption,mspeed,frm,endfrm),"frame0");
										}
									}
								  		...
								  		jQuery.each(tweens,function(index,tween) {
									  		if (tween.vars.data != undefined) {
									  			...
									  			if (tween.progress() !=1 && tween.progress()!=0) {
										  			...
										  			if (tween.progress()==1) {
											  				punchgs.Tweenlight.set(tween.target,{x:newx,y:newy});
											  		}
											  	}
									  		}
								  		})
				...
				********************************/
				...
				var callCaptionLoops = function(nextcaption,factor) {
									...
									nextcaption.find('.rs-pendulum').each(function() {
										...
										if (el.data('timeline')==undefined) {
											el.data('timeline',new punchgs.Timelinelight);
											...
											el.data('timeline').append(new punchgs.Tweenlight.fromTo(el,speed,{force3D:"auto",rotation:startdeg,transformOrigin:origin},{rotation:enddeg,ease:easing}));
											el.data('timeline').append(new punchgs.Tweenlight.fromTo(el,speed,{force3D:"auto",rotation:enddeg,transformOrigin:origin},{rotation:startdeg,ease:easing,onComplete:function() {
									...
									nextcaption.find('.rs-rotate').each(function() {
										...
										if (el.data('timeline')==undefined) {
											...
											el.data('timeline').append(new punchgs.Tweenlight.fromTo(el,speed,{force3D:"auto",rotation:startdeg,transformOrigin:origin},{rotation:enddeg,ease:easing,onComplete:function() {
												el.data('timeline').restart();
											}}));
										}
									...
									nextcaption.find('.rs-slideloop').each(function() {
										...
										if (el.data('timeline')==undefined) {
											...
											el.data('timeline').append(new punchgs.Tweenlight.fromTo(el,speed,{force3D:"auto",x:xs,y:ys},{x:xe,y:ye,ease:easing}));
											el.data('timeline').append(new punchgs.Tweenlight.fromTo(el,speed,{force3D:"auto",x:xe,y:ye},{x:xs,y:ys,onComplete:function() {
												el.data('timeline').restart();
											}}));
										}
									...
									nextcaption.find('.rs-pulse').each(function() {
										...
										if (el.data('timeline')==undefined) {
											...
											el.data('timeline').append(new punchgs.Tweenlight.fromTo(el,speed,{force3D:"auto",scale:zoomstart},{scale:zoomend,ease:easing}));
											el.data('timeline').append(new punchgs.Tweenlight.fromTo(el,speed,{force3D:"auto",scale:zoomend},{scale:zoomstart,onComplete:function() {
												el.data('timeline').restart();
											}}));
										}
									...
									nextcaption.find('.rs-wave').each(function() {
										...
										if (el.data('timeline')==undefined) {
											...
											var angobj = {a:0, ang : angle, element:el, unit:radius};
												...
												el.data('timeline').append(new punchgs.Tweenlight.fromTo(angobj,speed,
																			{	a:360	},
																			{	a:0,
																				force3D:"auto",
																				...
																				onUpdate:function() {
																		            ...
																		            punchgs.Tweenlight.to(angobj.element,0.1,{force3D:"auto",x:Math.cos(rad) * angobj.unit, y:angobj.unit * (1 - Math.sin(rad))});
							...
							if (staticdirection != 0 ) {
									...
									if (nextcaption.find('iframe').length>0) {
																	...
																	//if (nextcaption.data('vimeoid')!=undefined && String(nextcaption.data('vimeoid')).length>0)
																	  	punchgs.Tweenlight.to(nextcaption.find('iframe'),0.2,{autoAlpha:0});
									...
									try {
											...
											//var tl = punchgs.Timelinelight.exportRoot();
				...
				var endMoveCaption = function(nextcaption,opt,mdelay,backwards,frame,downscale) {
									...
									var tl = nextcaption.data('timeline'),
										newtl = new punchgs.Timelinelight();
										...
										ncc.match("randomrotateout"))
									{
										...
										//tl.add(punchgs.Tweenlight.to(nextcaption,mspeed,frm),mdelay);
									...
									if (nextcaption.hasClass("customout")) {
										...
										frm.onStart = function() {
																 ...
																 punchgs.Tweenlight.set(nextcaption,{
										...
										backwards.delay = 0;
										tl.add(punchgs.Tweenlight.to(nextcaption,mspeed,backwards),mdelay);
									}
			...
			if (opt.slideamount >1 && !(opt.stopAfterLoops==0 && opt.stopAtSlide==1) ) {
					...
					container.on('restarttimer',function() {
						...
						if ((opt.stopLoop=="on" && opt.next==opt.lastslidetoshow-1) || opt.noloopanymore == 1)
								...
								bt.css({visibility:"visible"});
								bt.data('tween').kill();
								bt.data('tween',punchgs.Tweenlight.fromTo(bt,opt.delay/1000,{width:"0%"},{force3D:"auto",width:"100%",ease:punchgs.Linear.easeNone,onComplete:countDownNext,delay:1}));
		...
		var nextli = container.find('>ul:first-child >li:eq('+opt.next+')'),
			...
			nextsh.find('.defaultimg').each(function() {
				...
				if (prepareonly) {
					...
					punchgs.Tweenlight.set(kbimg,{autoAlpha:0,
					...
					defimg.data('kenburn',punchgs.Tweenlight.fromTo(kbimg,dur,{autoAlpha:1, force3D:punchgs.force3d, transformOrigin:"0% 0%", top:0,left:0, scale:imgs.w, x:imgs.x, y:imgs.y},{autoAlpha:1,rotationZ:roe,ease:easeme, x:imge.x, y:imge.y,scale:imge.w,onUpdate:function() {
							...
							if (!isIE(8)) defimg.data('currotate',getRotationDegrees(kbimg));
							if (!isIE(8)) defimg.data('curscale',(imgobj.w*sx)+"%  "+(imgobj.h*sx+"%"));
							//punchgs.Tweenlight.set(defimg,{rotation:defimg.data('currotate'), backgroundPosition:defimg.data('bgposition'), backgroundSize:defimg.data('curscale')});
					}}));
		})
	}
		...
		********************************/
		var stopKenBurn = function(container,opt) {
			...
			container.find('.defaultimg').each(function() {
				var defimg = jQuery(this);
				punchgs.Tweenlight.killTweensOf(defimg,false);
				punchgs.Tweenlight.set(defimg,{scale:1,rotationZ:0});
				punchgs.Tweenlight.killTweensOf(defimg.data('kenburn img'),false);
				if (defimg.data('kenburn') != undefined) {
					defimg.data('kenburn').pause();
				}
				if (defimg.data('currotate') != undefined && defimg.data('bgposition') !=undefined && defimg.data('curscale') != undefined)
					punchgs.Tweenlight.set(defimg,{rotation:defimg.data('currotate'), backgroundPosition:defimg.data('bgposition'), backgroundSize:defimg.data('curscale')});
				if (defimg!= undefined && defimg.data('kenburn img') != undefined && defimg.data('kenburn img').length>0) punchgs.Tweenlight.set(defimg.data('kenburn img'),{autoAlpha:0});
...
**************************************************************************/
							...
							switch (event.type) {
								...
								case "mousemove":
										...
										currslide.find(".tp-parallax-container").each(function() {
											...
											if (opt.parallax=="scroll+mouse" || opt.parallax=="mouse+scroll")
												punchgs.Tweenlight.to(pc,0.4,{force3D:"auto",x:offsh,ease:punchgs.Power3.easeOut,overwrite:"all"});
											else
												punchgs.Tweenlight.to(pc,0.4,{force3D:"auto",x:offsh,y:offsv,ease:punchgs.Power3.easeOut,overwrite:"all"});
										})
								...
								case "mouseleave":
										currslide.find(".tp-parallax-container").each(function() {
											var pc = jQuery(this);
											if (opt.parallax=="scroll+mouse" || opt.parallax=="mouse+scroll")
												punchgs.Tweenlight.to(pc,1.5,{force3D:"auto",x:0,ease:punchgs.Power3.easeOut});
											else
												punchgs.Tweenlight.to(pc,1.5,{force3D:"auto",x:0,y:0,ease:punchgs.Power3.easeOut});
										})
								break;
							}
						});
							...
							window.ondeviceorientation = function(event) {
							  ...
							  currslide.find(".tp-parallax-container").each(function() {
												var pc = jQuery(this),
													...
													offsh =	curh * pl,
													offsv =	curv * pl;
												punchgs.Tweenlight.to(pc,0.2,{force3D:"auto",x:offsh,y:offsv,ease:punchgs.Power3.easeOut});
											})
		...
		***************************************/
		var scrollParallax = function(container,opt) {
			...
			container.find(".tp-parallax-container").each(function(i) {
				...
				punchgs.Tweenlight.to(pc,0.2,{force3D:"auto",y:offsv,ease:punchgs.Power3.easeOut});
			})

			if (opt.parallaxBgFreeze!="on") {
				var pl = opt.parallaxLevels[0]/100,
					offsv =	diffv * pl;
				punchgs.Tweenlight.to(container,0.2,{force3D:"auto",y:offsv,ease:punchgs.Power3.easeOut});
			}
		}
		...
		**************************************************************************/
		...
		var moveThumbSliderToPosition = function($this,pos,speed) {
			punchgs.Tweenlight.to($this.find('.tp-thumbcontainer'),0.2,{force3D:"auto",left:pos,ease:punchgs.Power3.easeOut,overwrite:"auto"});
		}
})(jQuery);
